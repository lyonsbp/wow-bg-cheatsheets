...
export default function EditBar() {
  ...
  return (
    <div className="px-3.5 py-[5px] bg-[var(--edit-bg)] border-b border-[var(--edit-border)] flex gap-2 items-center shrink-0 text-[var(--edit-text)]">
      ...
      <button className="px-2.5 py-1 rounded border border-[var(--danger-border)] bg-[var(--bg-surface)] text-[var(--danger)] cursor-pointer transition-all duration-[120ms] hover:bg-[var(--danger-hover-bg)] hover:border-[var(--danger)]" onClick={handleResetAll}>Reset All BGs</button>
